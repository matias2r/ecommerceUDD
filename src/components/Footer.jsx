    ...
    return (
        <footer className="bg-indigo-950 text-white">
            <div className="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:px-10">
                <div>
                    <div className="mt-4 mb-2 font-medium xl:mb-4">Redes Sociales</div>
                    <div className="flex flex-row space-x-4">
                        <a href="https://www.facebook.com/SPDigital/" target="_blank" className='bg-indigo-500 rounded px-2 hover:bg-indigo-400 transition'><i className="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/spdigital/" target="_blank" className='bg-indigo-500 rounded px-2 hover:bg-indigo-400 transition'><i className="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/sp-digital/" target="_blank" className='bg-indigo-500 rounded px-2 hover:bg-indigo-400 transition'><i className="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div className="mt-4 mb-8">
                    <div className="mb-2 font-medium xl:mb-4">Medios de Pago</div>
