                ...
                <div className="space-y-6 mt-5">
                    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:p-6">
                        ...
                        <div className="flex items-center justify-between md:order-3 md:justify-end">
                            ...
                            <button onClick={() => increaseQuantity(product.id)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100">
                            ...
                            <p className="text-base font-bold text-gray-900">${(price * product.quantity).toFixed(2)}</p>
                            </div>
                        </div>

                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                            <a href="#" className="text-base font-medium text-gray-900 hover:underline">{title}</a>

                            <div className="flex items-center gap-4">
                            <button onClick={() => removeFromCart(id)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
